...
fun mockFeedAllIdsValid(): String {
    return "{\n" +
            "  \"cards\": [\n" +
            "    {\n" +
            "      \"id\": \"xy7-10\",\n" +
...
fun mockFeedSomeIdsAbsent(): String {
    return "{\n" +
            "  \"cards\": [\n" +
            "    {\n" +
            "      \"id\": \"\",\n" + // Set Id to empty
...
fun mockFeedAllIdsAbsent(): String {
    return "{\n" +
            "  \"cards\": [\n" +
            "    {\n" +
//            "      \"id\": \"xy7-10\",\n" +
...
fun mockFeedSomeItemsEmpty(): String {
    return "{\n" +
            "  \"cards\": [\n" +
            "    {\n" +
            "      \"id\": \"xy7-10\",\n" +
